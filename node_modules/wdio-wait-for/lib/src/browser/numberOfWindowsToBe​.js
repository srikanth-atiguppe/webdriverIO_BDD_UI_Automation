...
exports.numberOfWindowsToBe = void 0;
/**
 ...
 */
function numberOfWindowsToBe(expectedNumber) {
    return function () {
        return __awaiter(this, void 0, void 0, function* () {
            const actualWindows = yield this.getWindowHandles();
            return actualWindows.length === expectedNumber;
        });
    };
}
exports.numberOfWindowsToBe = numberOfWindowsToBe;
