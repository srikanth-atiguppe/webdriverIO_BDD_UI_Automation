...
exports.elementToBeSelected = void 0;
 ...
 */
function elementToBeSelected(selectorOrElement) {
    return function () {
        return __awaiter(this, void 0, void 0, function* () {
            const element = yield (0, utils_1.getElement)(selectorOrElement);
            return yield element.isSelected();
        });
    };
}
exports.elementToBeSelected = elementToBeSelected;
