 ...
 */
export declare function numberOfElementsToBe(selectorOrElementArray: string | ChainablePromiseArray<WebdriverIO.ElementArray>, expectedNumber: number): () => Promise<boolean>;
