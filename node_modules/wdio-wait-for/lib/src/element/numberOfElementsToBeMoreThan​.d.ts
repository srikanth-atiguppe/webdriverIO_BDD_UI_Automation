 ...
 */
export declare function numberOfElementsToBeMoreThan(selectorOrElementArray: string | ChainablePromiseArray<WebdriverIO.ElementArray>, expectedNumber: number): () => Promise<boolean>;
