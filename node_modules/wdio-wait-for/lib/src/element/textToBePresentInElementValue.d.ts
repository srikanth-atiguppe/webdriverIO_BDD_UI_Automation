 ...
 */
export declare function textToBePresentInElementValue(selectorOrElement: string | ChainablePromiseElement<Promise<WebdriverIO.Element>>, expectedValue: string): () => Promise<boolean>;
